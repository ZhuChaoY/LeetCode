...
矩形的上下边平行于x轴，左右边平行于y轴。如果相交的面积为正，则称两矩形重叠。
...
提示： rect1.length == 4 rect2.length == 4 -109 <= rec1[i], rec2[i] <= 109
rec1[0]<=rec1[2] 且 rec1[1]<=rec1[3] rec2[0] <= rec2[2] 且 rec2[1] <= rec2[3]
'''
...
def isRectangleOverlap(rec1, rec2): 
    if rec1[0] == rec1[2] or rec1[1] == rec1[3] or \
       rec2[0] == rec2[2] or rec2[1] == rec2[3]:
           return False
    return not (rec2[1] >= rec1[3] or rec1[1] >= rec2[3] or 
                rec2[0] >= rec1[2] or rec1[0] >= rec2[2])
